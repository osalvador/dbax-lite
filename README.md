...
* [Routing](docs/Routing.md); simple but powerfull url routing. The URLs generated by dbax are clean and search-engine friendly.
* Modular (you can choose which components to use).
* Write SQL and PL/SQL. Use all PL/SQL libraries you like.
* Lightweight.
* Template Engine; dbax uses [tePLSQL](https://github.com/osalvador/tePLSQL) which has the same syntax as [Oracle PSP](http://docs.oracle.com/cd/E11882_01/appdev.112/e41502/adfns_psp.htm#ADFNS016).
