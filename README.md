...
* [x] [Routing](https://github.com/osalvador/dbax-lite/blob/master/doc/Routing.md); simple but powerfull url routing. The URLs generated by dbax are clean and search-engine friendly.
